...
If this does not load, navigate to the `Media` section to find sample clips.

<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Media Layout</title>
    <style>
        .container {
            display: grid;
...
<body>
    <div class="container">
        <div class="video-container">
            <video controls>
                <source src="media/hugh-jackman.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
        </div>
        <div class="video-container">
            <video controls>
                <source src="media/ryan-reynolds.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
        </div>
        <div class="image-container">
            <img src="media/hugh-jackman-reference-photo.jpg" alt="Hugh Jackman">
        </div>
        <div class="image-container">
            <img src="media/ryan-reynolds-reference-image.jpg" alt="Ryan Reynolds">
        </div>
    </div>
</body>
</html>